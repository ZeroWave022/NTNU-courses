package assignment0.todolist.fxui;

import java.io.IOException;
import java.io.InputStream;
import java.io.OutputStream;

import assignment0.todolist.model.TodoList;
...
public interface ITodoFileReading {
	...
	/**
	 * Read a TodoList with a given name, from a default (implementation-specific)
	 * location.
	 * 
	...
	/**
	 * Write a TodoList to a file named after the list in a default (implementation
	 * specific) location.
	 * 
	 * @param todoList The list to write
