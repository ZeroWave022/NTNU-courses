...
public class Rectangle {
    ...
    public boolean contains(Rectangle other) {
        ...
        // if this
        // rectangle contains the entire other rectangle
    ...
    public boolean add(Rectangle other) {
        ...
        return this.add(other.getMinX(), other.getMinY())
                || this.add(other.getMaxX(), other.getMaxY());
    ...
    public Rectangle intersection(Rectangle rect) {
        int minX = Math.max(this.getMinX(), rect.getMinX());
        int minY = Math.max(this.getMinY(), rect.getMinY());
        int maxX = Math.min(this.getMaxX(), rect.getMaxX());
        int maxY = Math.min(this.getMaxY(), rect.getMaxY());
    ...
    public String toString() {
        return String.format("[Rectangle %s-%s,%s-%s %sx%s]", this.getMinX(), this.getMaxX(),
                this.getMinY(), this.getMaxY(), this.getWidth(), this.getHeight());
    }
}
